...
class CapabilityRegistry:
    ...
    def discover(self, provider: str | None = None, permission: str | None = None) -> list[Skill]:
        ...
        results = self.skills
        if provider:
            results = [s for s in results if "all" in s.providers or provider in s.providers]
        if permission:
            results = [
                s
                for s in results
            ...
            "skills": [
                {
                    ...
                    "outputs": [
                        {"type": o.type, "path_template": o.path_template, "schema": o.schema}
                        for o in s.outputs
                    ],
                    ...
                    "sandbox": {
                        ...
                        "filesystem": s.sandbox.filesystem,
                        "timeout": s.sandbox.timeout,
                    },
                    "schedule": s.schedule,
                }
